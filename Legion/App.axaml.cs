            ...
            if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
            {
                ...
                if (context.Database.CanConnect())
                {
                    ...
                    if (!context.Users.Any())
                    {
                        ...
                        await context.ContractTypes.AddAsync(new ContractType() { ContractIdFormat = "id/yy", Bet = 3, Formula = "x*p", Period = 24, TypeName = "ТАНАКА инвестиционный", CanAddMoney = false, NextYearBetCoef = 1 });
