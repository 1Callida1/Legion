...
namespace Legion.Helpers.ReportGenerator
{
    ...
    {
        public static void GenerateDocument(Models.Contract cntr, string documentType)
        {
                ...
                using (Editor editor = new Editor(delegate { return fs; }, delegate { return loadOptions; }))
                {
                    ...
                    using (EditableDocument beforeEdit = editor.Edit(editOptions))
                    {
                        ...
                        switch (documentType)
                        {
                            ...
                            case "Договор инвестирования":
                                {
                                    TemplateName = $"Договор инвестирования {contract.Investor.LastName} {contract.Investor.FirstName[0]}. {contract.Investor.MiddleName[0]}.";
                                    CultureInfo culture = new CultureInfo("ru-RU");
                                    editedContent = originalContent
